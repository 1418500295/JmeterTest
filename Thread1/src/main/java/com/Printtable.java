...
public class PrintTable {
    ...
    //表格头信息
    public final List<List<String>> headerList = new ArrayList<>();

    //表格体信息
    public final List<List<String>> bodyList = new ArrayList<>();

    //每列最大字符个数
    public List<Integer> columnCharCount;
     ...
     * @param values  填充值
     */
    public void fillColumns(List<String> columns, String[] values) {
     ...
     */
    public void fillRows(StringBuilder sb, List<List<String>> list) {
     ...
     * @param row 一行数据
     */
    public void fillRow(StringBuilder sb, List<String> row) {
     ...
     */
    public void fillBorder(StringBuilder sb) {
        sb.append(CORNER);
     ...
     * @param value 字符串
     */
    public int nonSbcCount(String value) {
        int count = 0;
    ...
    public static void printTable(PrintTable printTable1) {
        printTable1.addHeader("姓名", "年龄", "住址", "email");
